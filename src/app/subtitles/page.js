...
<>
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-950 to-black text-white p-8 rounded-lg shadow-lg">
      <h2 className="text-3xl font-extrabold mb-6 text-white">
        <FileText className="inline-block mr-2 bg-gray-900" size={30} />
        Subtitles Ready
      </h2>
      ...
      <div className="w-full max-w-xl flex flex-col space-y-4">
        ...
        <textarea
          ...
          rows={5}
          placeholder="Enter your text here to generate subtitles..."
        />
